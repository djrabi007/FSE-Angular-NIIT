...
//import com.stackroute.keepnote.service.NextSequenceService;
   ...
   // @Mock
    ...
    public void setUp()
    {
      ...
      //  reminder.setReminderId("5b0509731764e3096984eae6");
        ...
        //ReflectionTestUtils.setField(reminderService, "nextSequenceService", nextSequenceService);
       // when(nextSequenceService.getNextSequence(any())).thenReturn(1);
    }
    ...
    public void createReminderSuccess() throws ReminderNotCreatedException
    {
        ...
        when(reminderRepository.save((Reminder) any())).thenReturn(reminder); //Rabi
    ...
    public void createReminderFailure() throws ReminderNotCreatedException
    {
        ...
        when(reminderRepository.save((Reminder) any())).thenReturn(null);
        Reminder reminderSaved = reminderService.createReminder(reminder);
        Assert.assertEquals(reminder, reminderSaved);
    }
