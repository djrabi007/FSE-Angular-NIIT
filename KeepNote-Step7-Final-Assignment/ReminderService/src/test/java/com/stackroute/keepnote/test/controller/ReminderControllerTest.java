...
import com.stackroute.keepnote.ReminderServiceApplication;
...
@ContextConfiguration(classes= {ApiSecurityConfig.class,ReminderServiceApplication.class})
public class ReminderControllerTest {
    ...
    public void deleteReminderSuccess() throws Exception
    {
        ...
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/reminder/abcd1234/5b0509731764e3096984eae6").
    ...
    public void getReminderByIdFailure() throws Exception
    {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/reminder/abcd1234/5b0509731764e3096984eae6").
                contentType(MediaType.APPLICATION_JSON).content(asJsonString(reminder)))
                .andExpect(MockMvcResultMatchers.status().isNotFound())
                .andDo(MockMvcResultHandlers.print());
