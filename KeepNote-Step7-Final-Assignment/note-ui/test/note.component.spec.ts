...
const testConfig = {
  getNotes: {
    ...
    negative: [],
    editNotePath: '/dashboard/view/noteview/(noteEditOutlet:note/1/edit)'
  }
};
...
describe('NoteComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      ...
      providers: [ RouterService,NotesService]
    })
    .compileComponents();
  }));
  ...
  it('should handle click event of card and navigate to edit note route', fakeAsync(() => {
    ...
    if (debugElement) {
      ...
      element.click();
      tick();
      expect('/dashboard/view/noteview/(noteEditOutlet:note/1/edit)').toBe(testConfig.getNotes.editNotePath,
        `should navigate to 'edit note' route and url should be as '/dashboard/view/noteview/(noteEditOutlet:note/1/edit')`);
     } else {
      expect(false).toBe(true,
