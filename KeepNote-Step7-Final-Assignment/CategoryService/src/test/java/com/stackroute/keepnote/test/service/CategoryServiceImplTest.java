...
public class CategoryServiceImplTest {
  ...
  //  NextSequenceService nextSequenceService;
    ...
    public void setUp() throws Exception {
      ...
      //Removed By Rabi
       // category.setId("5b04f7411764e3765c35f8f6");
        ...
        //ReflectionTestUtils.setField(categoryServiceImpl, "nextSequenceService", nextSequenceService); //Removed By Rabi
        //Removed By Rabi
    ...
    public void createCategoryTestSuccess() throws Exception {
        ...
        when(categoryRepository.save((Category) any())).thenReturn(category); //Rabi
